...
class DFDMultiDataset(CustomDataset):
    """YeWu dataset for FAS.
    The annotation format is show as follows:
        -- annotation.txt
            ...
            img_path/img_name.jpg label
            ...
    Args:
    ...
    def __init__(self,
        ...
        super(DFDMultiDataset, self).__init__(
            data_root,
            ann_files,
            pipeline,
            img_prefix,
    ...
    def load_annotations(self, ann_files):
        ...
        for i, ann_file in enumerate(ann_files):
            ...
            count = 0
            for line in lines:
                label = lable2class_dict[lable_dict[line[-1]]] if len(line)>1 else -1
                count += 1
                _lmks.append(np.zeros((1,self.lm_num//2, 2)))
        ...
        self.num_classes = len(lable2class_dict)
